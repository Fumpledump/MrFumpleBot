...
//Logging Command
logcommand(message, "startstocktimer");
...
function stockChange() {
  console.log("•Stock Market Change");
  setTimeout(stockChange, getRandomArbitrary(1.8e+6, 7.2e+6));
  ...
  let newstock1Value = Math.round(getNewStockValue(stock1posneg, stocks.stock_1_value, stock1Change));
  let newstock2Value = Math.round(getNewStockValue(stock2posneg, stocks.stock_2_value, stock2Change));
  let newstock3Value = Math.round(getNewStockValue(stock3posneg, stocks.stock_3_value, stock3Change));
  let newstock4Value = Math.round(getNewStockValue(stock4posneg, stocks.stock_4_value, stock4Change));
  let newstock5Value = Math.round(getNewStockValue(stock5posneg, stocks.stock_5_value, stock5Change));
  let newstock6Value = Math.round(getNewStockValue(stock6posneg, stocks.stock_6_value, stock6Change));
  let newstock7Value = Math.round(getNewStockValue(stock7posneg, stocks.stock_7_value, stock7Change));
  let newstock8Value = Math.round(getNewStockValue(stock8posneg, stocks.stock_8_value, stock8Change));
  let newstock9Value = Math.round(getNewStockValue(stock9posneg, stocks.stock_9_value, stock9Change));

  console.log("---Stock Changes---")
  console.log(stock1Change);
  console.log(stock2Change);
  console.log(stock3Change);
  console.log(stock4Change);
  console.log(stock5Change);
  console.log(stock6Change);
  console.log(stock7Change);
  console.log(stock8Change);
  console.log(stock9Change);

  console.log("---Stock PosNegs---")
  console.log(stock1posneg);
  console.log(stock2posneg);
  console.log(stock3posneg);
  console.log(stock4posneg);
  console.log(stock5posneg);
  console.log(stock6posneg);
  console.log(stock7posneg);
  console.log(stock8posneg);
  console.log(stock9posneg);
  ...
  .setAuthor(response.stock_change_author.format(botconfig.botname), bot.user.displayAvatarURL)
  .setTitle(stockTitle)
...
setTimeout(stockChange, getRandomArbitrary(1.8e+6, 7.2e+6));
message.channel.send("`Stock Timer Started.`");
console.log("•Stock Timer Started")
}

module.exports.help = {
name: "startstocktimer",
aliases: []
}
